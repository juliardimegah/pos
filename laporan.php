...
<body>
	<header>
		<nav class="nav-menu">
			<ul>
				<h1 class="logo"><a href="#" title="POSWEB"></a></h1>
		...
		<div class="content-laporan">
			...
			<table class="table-laporan">
				...
				<tr>
					...
					<td colspan="2">
						<?php
							$totalPemasukan = queryRead("SELECT SUM(total) AS total_pemasukan FROM laporan_transaksi")[0]["total_pemasukan"];
							echo "Rp" . number_format($totalPemasukan, 0, ",", ".");
						?>
					</td>
				</tr>
			</table>
